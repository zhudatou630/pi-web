...
test("promotes pre-tool text longer than 200 characters into the answer", async () => {
...
test("keeps pre-tool text of exactly 200 characters in process blocks", async () => {
  const { PROCESS_TEXT_PROMOTE_MIN_CHARS, splitFinalAssistantBlocks } = await loadSubject();

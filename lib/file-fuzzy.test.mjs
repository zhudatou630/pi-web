...
test("builds line-scoped file mentions", async () => {
  ...
  assert.equal(buildFileLineMentionText("src/app.ts", Number.NaN, Number.POSITIVE_INFINITY), "@src/app.ts:1 ");
  assert.equal(buildFileLineMentionText("src/app.ts", 1.5, -2), "@src/app.ts:1 ");
});

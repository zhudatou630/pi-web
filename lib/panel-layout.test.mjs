...
test("panel transition grows sublinearly with width and is capped", () => {
  assert.equal(getPanelTransitionMs(260), 200);
  assert.equal(getPanelTransitionMs(640), 314);
  assert.equal(getPanelTransitionMs(1200), 360);
  assert.ok(getPanelTransitionMs(180) < 200);
});

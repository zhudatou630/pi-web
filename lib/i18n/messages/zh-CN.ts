...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typography": "等宽字体与几何对齐",
    "settings.typographyDescription": "优先使用浏览器已安装的 Sarasa Term SC。未安装时不会自动下载，可按需缓存 Regular 网页字体。",
    ...
    "agents.globalNote": "全局配置，对所有项目生效。",
    ...
    "appUpdate.currentVersion": "当前版本：v{version}",
    "appUpdate.checking": "正在检查更新…",
    "appUpdate.upToDate": "未发现新版本",
    "appUpdate.checkFailed": "检查更新失败，请稍后重新打开设置。",
    ...
    "models.providerIdHint": "服务商 ID：{id}（设置、密钥、聊天都用它）",
    ...
    "models.sectionOverrideHint": "留空则使用内置默认值。点击底部「保存」后写入 models.json。",
    ...
    "models.definitionHint": "定义在 models.json 中",
    "models.overrideHint": "修改会以覆盖项保存到 models.json",
    "models.deleteDefinition": "删除模型",
    "models.deleteEndpoint": "删除服务商",
    "models.sectionConnection": "连接",
    "models.sectionConnectionHint": "凭证保存在 auth.json，立即生效。",
    "models.sectionEndpoint": "端点",
    "models.sectionDraftHint": "点击底部「保存」后写入 models.json。",

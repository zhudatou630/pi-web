...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "装两个 TTF 包：正文与标题用 Sarasa UI SC，代码块、终端与 ASCII 架构图用 Sarasa Term SC。Term 版的中英文严格 2:1 对齐；UI 版为比例字体，正文阅读更舒服。",
    "settings.fontMonoDownload": "获取 Sarasa UI SC + Term SC（TTF）",

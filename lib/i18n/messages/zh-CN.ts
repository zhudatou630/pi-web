...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteProjectSessionsConfirm": "删除 {name} 的 {count} 个会话？",
    "sidebar.deleteProjectSessionsAction": "删除 {count} 个会话",
    "sidebar.deleteProjectSessionsDetail": "将删除 {name} 的全部 {count} 个会话（含 worktree 与子代理会话）。磁盘上的项目目录不受影响。此操作不可撤销。",

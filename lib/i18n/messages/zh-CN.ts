...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "代码块、终端与 ASCII 架构图优先匹配更纱黑体（Sarasa Term SC / Nerd）与 Maple Mono。在本地系统安装该字体后，即可自动实现中英文 2:1 像素级几何等宽对齐。",
    "settings.fontMonoDownload": "获取更纱黑体 Term SC",

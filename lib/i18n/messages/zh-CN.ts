...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.fontMonoDownload": "获取更纱黑体 (Sarasa Gothic)",
    ...
    "image.default": "默认",
    "image.target": "目标图",
    "image.addTarget": "选择目标图",
    "image.references": "参考图",
    "image.addReference": "添加参考图",
    "image.remove": "移除图片",
    "image.edit": "改图",
    "image.quote": "引用",
    "image.generate": "生成",
    ...
    "image.abort": "停止生成",
    "image.invalidFile": "请选择 PNG、JPEG 或 WebP 图片。",
    "image.fileTooLarge": "每张图片不能超过 20 MB。",

...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.pickOnlyThese": "挑选模型…",
    "models.availableMore": "+ 还有 {count} 个可添加",
    ...
    "models.listWritten": "已写固定名单，原来的规则不再生效。",
    ...
    "models.tabChat": "聊天模型",
    "models.tabProviders": "服务商",
    "models.chatAllTitle": "聊天可以使用全部可用模型（{count} 个）",
    "models.chatListTitle": "聊天只提供以下 {count} 个模型",
    "models.chatScopeDesc": "这些模型会出现在聊天的模型选择器里。修改会立即保存到{where}。",
    "models.scopeWhereGlobal": "全局设置",
    "models.scopeWhereProject": "当前项目设置",
    "models.addToChat": "添加模型",
    "models.chatEmpty": "还没有可用模型，先连接一个服务商。",
    "models.manageProvider": "管理",
    "models.editParams": "参数",
    "models.showInChat": "在聊天中显示",
    "models.chatSwitchHint": "开关决定模型是否出现在聊天里，切换后立即保存。",
    "models.chatAllSwitchHint": "聊天当前使用全部模型。到「聊天模型」页挑选后，可以逐个开关。",

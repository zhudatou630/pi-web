...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.providerIdTaken": "这个 Provider ID 已存在。",
    ...
    "models.pickOnlyThese": "只显示我选的",
    "models.availableMore": "还有 {count} 个可用",
    ...
    "models.providerIdHint": "Provider id：{id}（设置、密钥、聊天都用它）",
    "models.definitions": "模型定义",

...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.chatAllTitle": "Chat offers all {count} available models",
    "models.chatListTitle": "Chat offers {count} selected models",
    "models.chatScopeDesc": "Saved to {where}; switches take effect immediately.",

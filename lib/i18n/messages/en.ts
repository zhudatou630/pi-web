...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "Code blocks, terminals, and ASCII diagrams prioritize Sarasa Term SC / Nerd and Maple Mono. Installing them locally provides exact 2:1 geometric alignment between CJK and Latin characters.",
    "settings.fontMonoDownload": "Get Sarasa Term SC",
    ...
    "chatMinimap.userOutline": "Questions",

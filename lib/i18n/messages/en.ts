...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agents.globalNote": "Global profile: applies to every project.",
    ...
    "appUpdate.currentVersion": "Current version: v{version}",
    "appUpdate.checking": "Checking for updates…",
    "appUpdate.upToDate": "No new version found",
    "appUpdate.checkFailed": "Could not check for updates. Reopen settings to try again later.",
    ...
    "models.providerIdHint": "Provider id: {id} (used by settings, keys, and chat)",
    ...
    "models.sectionOverrideHint": "Leave fields blank to use the built-in defaults. Saved to models.json when you click Save below.",
    ...
    "models.definitionHint": "Defined in models.json",
    "models.overrideHint": "Changes are saved as overrides in models.json",
    "models.deleteDefinition": "Delete model",
    "models.deleteEndpoint": "Delete provider",
    "models.sectionConnection": "Connection",
    "models.sectionConnectionHint": "Credentials are stored in auth.json and take effect immediately.",
    "models.sectionEndpoint": "Endpoint",
    "models.sectionDraftHint": "Saved to models.json when you click Save below.",
    "models.sectionModels": "Models ({count})",

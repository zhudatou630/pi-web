...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.pickOnlyThese": "Choose models…",
    "models.availableMore": "+ {count} more available",
    ...
    "models.listWritten": "Written as a fixed list; the previous rule no longer applies.",
    ...
    "models.tabChat": "Chat models",
    "models.tabProviders": "Providers",
    "models.chatAllTitle": "Chat offers every available model ({count})",
    "models.chatListTitle": "Chat offers these {count} models",
    "models.chatScopeDesc": "These models appear in the chat model picker. Changes are saved to {where} immediately.",
    "models.scopeWhereGlobal": "global settings",
    "models.scopeWhereProject": "this project's settings",
    "models.addToChat": "Add models",
    "models.chatEmpty": "No models are available yet. Connect a provider first.",
    "models.manageProvider": "Manage",
    "models.editParams": "Parameters",
    "models.showInChat": "Show in chat",
    "models.chatSwitchHint": "The switch controls whether a model appears in chat; it saves immediately.",
    "models.chatAllSwitchHint": "Chat currently offers every model. Choose models on the Chat models tab to control them one by one.",

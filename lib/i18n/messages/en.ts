...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "Install two packages as TTF: Sarasa UI SC for prose and headings, Sarasa Term SC for code blocks, terminals, and ASCII diagrams. The Term face aligns CJK and Latin at exactly 2:1; the UI face is proportional and reads better in prose.",
    "settings.fontMonoDownload": "Get Sarasa UI SC + Term SC (TTF)",

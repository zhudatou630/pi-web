...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteProjectSessionsConfirm": "Delete {count} sessions of {name}?",
    "sidebar.deleteProjectSessionsAction": "Delete {count} sessions",
    "sidebar.deleteProjectSessionsDetail": "Deletes all {count} sessions of {name}, including worktree and subagent sessions. The project folder on disk is not affected. This cannot be undone.",

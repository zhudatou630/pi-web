...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.chatAll": "Chat currently uses every model",
    ...
    "models.pickOnlyThese": "Only show the ones I choose",
    ...
    "models.chatList": "Chat only shows the models below.",
    ...
    "models.definitions": "Model definitions",

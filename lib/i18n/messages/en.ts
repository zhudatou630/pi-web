...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.fontMonoDownload": "Get Sarasa Gothic",
    ...
    "image.addTarget": "Choose target",
    "image.references": "References",
    "image.addReference": "Add reference",
    "image.remove": "Remove image",
    "image.edit": "Edit",
    "image.quote": "Quote",
    "image.generate": "Generate",
    "image.generating": "Generating…",
    "image.abort": "Stop generation",
    "image.invalidFile": "Choose a PNG, JPEG, or WebP image.",
    "image.fileTooLarge": "Each image must be 20 MB or smaller.",

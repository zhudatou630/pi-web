...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "裝兩個 TTF 套件：正文與標題用 Sarasa UI SC，程式碼區塊、終端機與 ASCII 架構圖用 Sarasa Term SC。Term 版的中英文嚴格 2:1 對齊；UI 版為比例字型，正文閱讀更舒適。",
    "settings.fontMonoDownload": "取得 Sarasa UI SC + Term SC（TTF）",

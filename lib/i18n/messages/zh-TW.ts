...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.typographyDescription": "代碼塊、終端機與 ASCII 架構圖優先配對更紗黑體（Sarasa Term SC / Nerd）與 Maple Mono。於本機系統安裝該字型後，即可自動達成中英文 2:1 像素級幾何等寬對齊。",
    "settings.fontMonoDownload": "取得更紗黑體 Term SC",

...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.fontMonoDownload": "取得更紗黑體 (Sarasa Gothic)",
    ...
    "image.default": "預設",
    "image.target": "目標圖",
    "image.addTarget": "選擇目標圖",
    "image.references": "參考圖",
    "image.addReference": "新增參考圖",
    "image.remove": "移除圖片",
    "image.edit": "改圖",
    "image.quote": "引用",
    "image.generate": "生成",
    ...
    "image.abort": "停止生成",
    "image.invalidFile": "請選擇 PNG、JPEG 或 WebP 圖片。",
    "image.fileTooLarge": "每張圖片不得超過 20 MB。",

...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agents.globalNote": "全域設定，對所有專案生效。",
    ...
    "models.providerIdHint": "服務商 ID：{id}（設定、金鑰、聊天都用它）",
    ...
    "models.sectionOverrideHint": "留空則使用內建預設值。點擊底部「儲存」後寫入 models.json。",
    ...
    "models.definitionHint": "定義在 models.json 中",
    "models.overrideHint": "修改會以覆寫項儲存到 models.json",
    "models.deleteDefinition": "刪除模型",
    "models.deleteEndpoint": "刪除服務商",
    "models.sectionConnection": "連接",
    "models.sectionConnectionHint": "憑證儲存在 auth.json，立即生效。",
    "models.sectionEndpoint": "端點",
    "models.sectionDraftHint": "點擊底部「儲存」後寫入 models.json。",
    "models.sectionModels": "模型（{count}）",

...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.pickOnlyThese": "挑選模型…",
    "models.availableMore": "+ 還有 {count} 個可加入",
    ...
    "models.listWritten": "已寫固定名單，原本的規則不再生效。",
    ...
    "models.tabChat": "聊天模型",
    "models.tabProviders": "服務商",
    "models.chatAllTitle": "聊天可以使用全部可用模型（{count} 個）",
    "models.chatListTitle": "聊天只提供以下 {count} 個模型",
    "models.chatScopeDesc": "這些模型會出現在聊天的模型選擇器裡。修改會立即儲存到{where}。",
    "models.scopeWhereGlobal": "全域設定",
    "models.scopeWhereProject": "目前專案設定",
    "models.addToChat": "加入模型",
    "models.chatEmpty": "還沒有可用模型，先連接一個服務商。",
    "models.manageProvider": "管理",
    "models.editParams": "參數",
    "models.showInChat": "在聊天中顯示",
    "models.chatSwitchHint": "開關決定模型是否出現在聊天裡，切換後立即儲存。",
    "models.chatAllSwitchHint": "聊天目前使用全部模型。到「聊天模型」頁挑選後，可以逐個開關。",

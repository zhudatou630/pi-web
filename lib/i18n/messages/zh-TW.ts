...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.pickOnlyThese": "只顯示我選的",
    "models.availableMore": "還有 {count} 個可用",
    ...
    "models.providerIdHint": "Provider id：{id}（設定、金鑰、聊天都用它）",
    "models.definitions": "模型定義",

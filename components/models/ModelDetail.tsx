    ...
    <div className="models-form">
      ...
      <section className="models-section">
        ...
        >
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="models-disclosure-chevron">
